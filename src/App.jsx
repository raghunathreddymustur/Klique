...
import { Users, Shield, Target, CheckCircle, Lock, Zap, BookOpen, Music, Tv, Dumbbell, Code, Coffee, Smartphone, Heart, X, MessageCircle, Briefcase, Trophy, Rocket, Globe, Brain, Sun, Apple, Plus, Bell, Search, UserCheck, MessageSquare, PenTool, CreditCard, Guitar, Sparkles, Fingerprint, Calendar, MapPin, ArrowRight, Menu, Loader } from 'lucide-react';
...
const IconStream = ({ speed = "normal", direction = "left" }) => {
    ...
    const uniqueIcons = [
        { Icon: Briefcase, color: "text-blue-400", bg: "bg-blue-900/30", label: "Interview Prep" },
        { Icon: Music, color: "text-pink-400", bg: "bg-pink-900/30", label: "Learn Guitar" },
        { Icon: Trophy, color: "text-purple-400", bg: "bg-purple-900/30", label: "Sports Buddy" },
        { Icon: Rocket, color: "text-orange-400", bg: "bg-orange-900/30", label: "Startup Founder" },
        { Icon: CreditCard, color: "text-green-400", bg: "bg-green-900/30", label: "Split Sub" },
        { Icon: Code, color: "text-indigo-400", bg: "bg-indigo-900/30", label: "Coding" },
        { Icon: Globe, color: "text-teal-400", bg: "bg-teal-900/30", label: "Language" },
        { Icon: Tv, color: "text-red-400", bg: "bg-red-900/30", label: "Netflix" },
        { Icon: Brain, color: "text-pink-400", bg: "bg-pink-900/30", label: "Mindful" },
        { Icon: BookOpen, color: "text-emerald-400", bg: "bg-emerald-900/30", label: "Study" },
        { Icon: Sun, color: "text-amber-400", bg: "bg-amber-900/30", label: "5 AM Club" },
        { Icon: Apple, color: "text-green-400", bg: "bg-green-900/30", label: "Diet" },
        { Icon: Coffee, color: "text-slate-400", bg: "bg-slate-800", label: "Deep Work" },
        { Icon: Dumbbell, color: "text-cyan-400", bg: "bg-cyan-900/30", label: "Gym" },
    ];
        ...
        <div className="relative w-full max-w-[320px] md:max-w-sm h-[480px] bg-slate-900 rounded-[3rem] border-8 border-slate-800 shadow-2xl overflow-hidden animate-pulse-glow mx-auto transform hover:scale-105 transition-transform duration-500">
            ...
            <div className="h-full w-full bg-slate-950 relative p-4 flex flex-col pt-12">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    </div>        <div className="h-2 w-16 bg-slate-800 rounded-full"></div>
                </div>
                ...
                <div className="flex-1 relative">
                    ...
                    <div className={`absolute w-full transition-all duration-500 ${step === 0 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
                        <div className="bg-slate-900/50 p-4 rounded-2xl border border-slate-800 mb-4">
                            ...
                            <p className="text-slate-500 text-xs mb-4">Find a partner.</p>

                            <div className="space-y-3">
                                <div className="h-10 bg-slate-800 rounded-lg w-full flex items-center px-3 text-xs text-slate-400">
                                    <Trophy className="w-4 h-4 mr-2" /> Sports Companion
                                </div>
                                <div className="h-10 bg-slate-800 rounded-lg w-full flex items-center px-3 text-xs text-slate-400">
                                    <Sun className="w-4 h-4 mr-2" /> Weekend Tennis
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={`absolute w-full transition-all duration-500 ${step === 1 ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
                        <div className="flex justify-between items-end mb-4">
                            <div>
                                ...
                                <p className="text-blue-400 text-xs font-mono">#Tennis #Sports</p>
                            </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-slate-800/80 p-3 rounded-xl border border-slate-700 flex items-center gap-3 animate-slide-up" style={{ animationDelay: '0.2s' }}>
                                <div className="w-10 h-10 rounded-full bg-purple-500/20 text-purple-400 flex items-center justify-center font-bold text-xs">RJ</div>
                                <div className="flex-1">
                                    <h4 className="text-white text-sm font-bold">Raj J.</h4>
                                    <p className="text-[10px] text-slate-400">Verified • Intermediate</p>
                                </div>
                            ...
                            <div className="bg-slate-800/80 p-3 rounded-xl border border-slate-700 flex items-center gap-3 animate-slide-up" style={{ animationDelay: '0.6s' }}>
                                <div className="w-10 h-10 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold text-xs">AL</div>
                                <div className="flex-1">
                                    <h4 className="text-white text-sm font-bold">Alex L.</h4>
                                    <p className="text-[10px] text-slate-400">Verified • Coach</p>
                                </div>
                                <div className="w-2 h-2 rounded-full bg-blue-500"></div>
                            </div>
                        </div>
                    ...
                    <div className={`absolute w-full transition-all duration-500 ${step === 2 ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                        ...
                        <div className="bg-slate-800 p-4 rounded-2xl border-2 border-blue-500 shadow-xl shadow-blue-900/20 relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-emerald-400 to-emerald-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">AL</div>
                                <div>
                                    <h4 className="text-white font-bold">Alex L.</h4>
                            ...
                            <p className="text-slate-400 text-xs mb-4 leading-relaxed bg-slate-900/50 p-2 rounded-lg">
                                "Hey! Played division tennis in college. Looking for regular weekend rallies."
                            </p>
                    ...
                    <div className={`absolute w-full h-full flex flex-col items-center justify-center transition-all duration-500 ${step === 3 ? 'opacity-100 scale-100' : 'opacity-0 scale-110'}`}>
                        ...
                        <p className="text-slate-400 text-center text-sm px-4 mb-8">
                            You and <span className="text-white font-bold">Alex</span> are now buddies.
                        </p>

                        <div className="w-full bg-slate-800/50 rounded-xl p-3 border border-slate-700 animate-slide-up">
                            <div className="flex items-center gap-3 mb-2">
                                <div className="w-6 h-6 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-[10px]">AL</div>
                                <span className="text-xs text-slate-300">Alex is typing...</span>
                            </div>
                            <div className="bg-slate-700/50 rounded-lg p-2 rounded-tl-none ml-2">
                                <p className="text-xs text-white">Awesome! Is Saturday 10am good for you?</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container mx-auto px-6 relative z-20 grid lg:grid-cols-2 gap-12 items-center">
                <div className="text-center lg:text-left pt-8 lg:pt-0">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white leading-[1.1] mb-6 tracking-tight">
                        Find a friend who shares <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">same goal or interest.</span>
                    </h1>

                    <p className="text-base md:text-lg text-slate-400 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                        Transform solo struggles into shared success. Match with verified partners for <span className="text-white font-semibold">Interview Prep</span>, <span className="text-white font-semibold">Learning an Instrument</span>, <span className="text-white font-semibold">Sports</span>, <span className="text-white font-semibold">Building Startups</span>, or <span className="text-white font-semibold">Sharing Subscriptions</span>.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        ...
                        >
                            <Zap className="w-4 h-4" /> Find a Buddy
                        </button>
                        <button
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                        Make <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Meaningful Connections</span>
                    </h2>
                    <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                        Stop scrolling through endless feeds. Connect with people who are on the same path as you. Real conversations, real progress.
                    </p>
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-xl hover:bg-slate-900/50 transition-colors border border-transparent hover:border-slate-800">
                            ...
                            <div>
                                <h3 className="text-white font-bold mb-1">Shared Purpose</h3>
                                <p className="text-sm text-slate-500">Match based on specific niches like #Startup or #Marathon Training.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800/50">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <span className="block text-xs text-slate-500">Shared Goal</span>
                                        <span className="text-sm text-slate-200 font-medium">Build SaaS MVP</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm text-slate-200 font-medium">Weekends & Evenings</span>
                                    </div>
                                </div>
                            </div>
    ...
    <section id="how-it-works" className="py-24 bg-slate-950 relative border-t border-slate-900 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            <div className="text-center mb-24">
                <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6">Your Journey to <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Consistent Growth</span></h2>
                <p className="text-slate-400 max-w-2xl mx-auto text-lg">Three simple steps to find your accountability partner.</p>
            </div>
                        ...
                        <div className="ml-20 md:ml-0 md:w-1/2 md:pr-16 md:text-right">
                            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-blue-500/30 transition-all hover:-translate-y-1 duration-300 group">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    Post your specific goal. Whether it's <span className="text-blue-300">#InterviewPrep</span> or <span className="text-blue-300">#Marathon</span>, be clear about what you need.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="relative flex flex-col md:flex-row items-center">
                        ...
                        <div className="ml-20 md:ml-0 md:w-1/2 md:pl-16 md:text-left">
                            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-purple-500/30 transition-all hover:-translate-y-1 duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Review & Select</h3>
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    You get 3 verified applications. Review their profiles and select the best fit. No endless swiping.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative flex flex-col md:flex-row items-center">
                        ...
                        <div className="ml-20 md:ml-0 md:w-1/2 md:pr-16 md:text-right">
                            <div className="p-6 rounded-2xl bg-slate-900/50 border border-slate-800 hover:border-emerald-500/30 transition-all hover:-translate-y-1 duration-300 group">
                                ...
                                <h3 className="text-xl font-bold text-white mb-2">Match & Chat</h3>
                                <p className="text-slate-400 text-sm leading-relaxed">
                                    It's a match! Chat opens instantly. Coordinate schedules, share progress, and keep each other accountable.
                                </p>
                            </div>
                        </div>
                        <div className="hidden md:block md:w-1/2"></div>
...
const WhyDifferent = () => (
    <section className="py-24 bg-slate-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 mb-16 text-center">
            <h2 className="text-3xl lg:text-5xl font-bold text-white mb-6">Why This App Is Different</h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">We aren't just another tracker or dating app. We solve for loneliness through connection.</p>
        </div>
        ...
        <div className="container mx-auto px-6 grid gap-12 max-w-6xl">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-8 hover:border-red-500/30 transition-colors duration-300">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-white">Not a Habit Tracker</h3>
                            <p className="text-sm text-slate-500">Focuses on human connection, not just discipline.</p>
                        </div>
                    </div>
                    <div className="space-y-4">
                        <div className="flex justify-between text-xs font-semibold uppercase tracking-wider border-b border-slate-800 pb-3 mb-2">
                            <span className="text-slate-500">Habit Apps</span>
                            <span className="text-blue-400">BuddyMatch</span>
                        </div>
                        {/* Rows */}
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> Solo tracking</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> Human accountability</span>
                        </div>
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> One-way motivation</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> Two-way support</span>
                        </div>
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> Metrics first</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> Conversation first</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-8 hover:border-purple-500/30 transition-colors duration-300">
                    <div className="flex items-center gap-3 mb-8">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-white">Not Social Media</h3>
                            <p className="text-sm text-slate-500">Optimizes for depth, not distraction.</p>
                        </div>
                    </div>
                    <div className="space-y-4">
                        <div className="flex justify-between text-xs font-semibold uppercase tracking-wider border-b border-slate-800 pb-3 mb-2">
                            <span className="text-slate-500">Social Apps</span>
                            <span className="text-blue-400">BuddyMatch</span>
                        </div>
                        {/* Rows */}
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> Infinite Feeds</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> 1:1 Conversation</span>
                        </div>
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> Likes & Followers</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> Shared Goals</span>
                        </div>
                        <div className="grid grid-cols-2 gap-4 text-sm items-center">
                            <span className="text-slate-500 flex items-center gap-2"><X className="w-3 h-3 text-red-500" /> Public Performance</span>
                            <span className="text-white flex items-center gap-2"><CheckCircle className="w-3 h-3 text-emerald-500" /> Private Growth</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="p-8 bg-slate-900/30 border border-slate-800 rounded-3xl hover:border-blue-500/30 transition-all hover:-translate-y-1">
                    ...
                    <h4 className="text-xl font-bold text-white mb-3">Purpose-Bound</h4>
                    <p className="text-slate-400 text-sm leading-relaxed">Matches exist only around a shared goal. No infinite browsing. Limited to 3 requests/day for intentional connections.</p>
                </div>
                ...
                <div className="inline-block p-1 rounded-3xl bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-blue-500/20">
                    <div className="px-8 py-10 rounded-[22px] bg-slate-950/80 backdrop-blur-xl border border-white/5 relative overflow-hidden">
                        ...
                        <p className="text-xl md:text-2xl font-medium text-slate-200 italic leading-relaxed">
                            "A privacy-first app to find a goal-aligned buddy to talk, share, and grow with — not track habits, not scroll feeds."
                        </p>
                    </div>
                </div>
            </div>
    ...
    return (
        <section id="join" className="py-24 bg-slate-950 flex flex-col items-center text-center px-6 border-t border-slate-900">
            <div className="max-w-2xl mx-auto w-full">
                ...
                <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">Find your Klique.</h2>
                <p className="text-slate-400 text-lg mb-10 max-w-lg mx-auto">
                    Stop growing alone. Enter your goal and email to get matched with your first verified buddy.
                </p>
                        ...
                        <form onSubmit={handleSubmit} className="p-2 flex flex-col md:flex-row gap-2 relative">
                            ...
                            <div className="flex-1 relative group">
                                ...
                                <input
                                    ...
                                    placeholder="Your primary goal (e.g. UPSC, Gym)"
                            ...
                            >
                                {status === 'loading' ? <Loader className="w-5 h-5 animate-spin" /> : 'Join Wishlist'}
                            </button>
                        </form>
                    )}
                </div>
    ...
    <footer className="bg-slate-950 py-8 border-t border-slate-900">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-slate-600 text-sm">
                &copy; {new Date().getFullYear()} BuddyMatch. All rights reserved.
            </div>
